...
/**
 * Public tool to verify a Verifiable Credential *or* resolve a DID using
 * cheqd Studio.  If the input starts with "did:" it performs DID resolution,
 * otherwise it treats the input as a VC (JWT or JSON) and verifies it.
 */
export default function VerifyCredentialPage() {
  ...
  return (
    <div className='mx-auto max-w-2xl space-y-8 py-10'>
      <Card>
        <CardHeader>
          <CardTitle>Verify Credential or DID</CardTitle>
        </CardHeader>
